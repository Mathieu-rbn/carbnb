...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    Car.create!(user_id: User.first.id, brand:"Peugeot", model:"304", origin:"French", year:"1969", address:"Köpenicker Str. 70, 10179 Berlin", location:"Berlin", , price:"250 euros", remote_photo_url: "https://res.cloudinary.com/mathieurobin1/image/upload/v1566465128/New_pics/French/Peugeot_304_Back_uxm6of.jpg")
